...
public class SimpleProxyRequesterMRUDP {
        ...
        */
        while (true) {
            ...
            try {
                ...
                mrudpClientSocket=new ReliableSocket(remoteAddressAsString, remotePort);

                final InputStream inFromUDTVNCVideoStream = mrudpClientSocket.getInputStream();
                final OutputStream outViaUDTVNCCommands = mrudpClientSocket.getOutputStream();
            ...
            } finally {
                {
                    try {
                        ...
                        if (mrudpClientSocket != null) {
                            mrudpClientSocket.close();
                        }
                    } catch (IOException e) {
                    }
