...
public class Rscc {
  ...
  private final SystemCommander systemCommander; // FIXME: try it with ProcessExecutor
   ...
   * @param key generated by requestKey(). // FIXME: there is no requestKey method?
   */
  ...
  public String requestTokenFromServer(int forwardingPort, String keyServerIp, int keyServerSshPort,
    ...
    // FIXME: get rid of unnecessary parameters
    StringBuilder command = new StringBuilder();
